...
with col2:      
  st.markdown(
              ...
              <div style="font-size: 1.1rem; line-height: 1.2; text-align: justify;">
                  <p>
                  Based in the United States, I am a <span style="color: #f5c542; font-weight: 500;">Master’s graduate specializing in Machine Learning</span> from the University of Arizona with 6 years of Industrial experience in <span class="highlight-name" style="font-weight: 500;">Applied AI, Machine Learning, Data Science, and Business Analytics</span>.
                  </p>
                  <p>
                  My journey began at Titan Company Limited as the Senior Data Scientist – New Product Development, where I combined <span class="highlight-name" style="font-weight: 500;">manufacturing analytics, business intelligence, and decision-support systems </span>to drive innovation for one of India’s largest consumer brands.
                  By leveraging advanced analytics and market intelligence, I identified a <span class="highlight-name" style="font-weight: 500;">₹1B opportunity</span>, that led to the launch of Sonata’s first-ever branded Skeletal Quartz Watch, resulting in a paradigm shift in brand perception and approximately, <span class="highlight-name" style="font-weight: 500;">170% growth in premium price segment.</span>
Beyond product innovation, I designed analytics driven decision support systems and process optimization initiatives that achieved approximately <span class="highlight-name" style="font-weight: 500;">75 – 80% reduction in costs and manufacturing lead times</span>. 
                  These experiences sparked me to engineer systems that enable better business decisions at scale. To strengthen my technical foundation, I pursued a Post Graduate Program in Data Science & Business Analytics from The University of Texas at Austin. 
                  </p>
                  <p>
                  Recognizing both my technical contributions and leadership potential, Titan inducted me into its  <span class="highlight-name" style="font-weight: 500;">top 10%</span> of emerging young leaders through its <span class="highlight-name" style="font-weight: 500;">Young Leadership Program </span> and sponsored Post Graduation in Business Management at XLRI. During this period, I led large-scale <span class="highlight-name" style="font-weight: 500;">merchandising analytics, product attribution, and consumer analytics </span>initiatives that optimized inventory planning and contributed to approximately <span class="highlight-name" style="font-weight: 500;">30% growth</span> in Titan Wedding Jewelry sales
                  . Subsequently, I spearheaded Titan’s enterprise Data Science Centre of Excellence, where I led the design and deployment of <span class="highlight-name" style="font-weight: 500;">production-ready AI solutions using Deep Learning, Large Language Models, Python, SQL, AWS, and Streamlit</span>. My work spanned merchandising analytics, geospatial intelligence, marketing content generation, text and audio mining, image analytics, customer segmentation, and retail network expansion, consistently delivering measurable <span class="highlight-name" style="font-weight: 500;">business improvements of 35–40% </span>across diverse business functions. More importantly, these experiences reinforced my belief that successful AI systems require not only accurate models, but also thoughtful engineering, deployment, and user trust.</p> 
<p> Motivated to deepen my expertise in modern AI systems, I pursued a Master's in Machine Learning at the University of Arizona. As a Graduate Researcher, I work at the intersection of <span class="highlight-name" style="font-weight: 500;">Agentic AI, Foundation Models, Information Retrieval, and Cloud Computing</span>, designing production-oriented AI systems that combine <span class="highlight-name" style="font-weight: 500;">LLM reasoning </span>with robust software engineering. My research includes developing <span class="highlight-name" style="font-weight: 500;">multi-agent architectures</span> using LangGraph, <span class="highlight-name" style="font-weight: 500;">Retrieval-Augmented Generation (RAG), and Model Context Protocol (MCP)</span>; building AI systems with integrated <span class="highlight-name" style="font-weight: 500;">evaluation, governance, guardrails, and observability; fine-tuning foundation models</span> using Parameter-Efficient Fine-Tuning (LoRA) for domain adaptation; designing <span class="highlight-name" style="font-weight: 500;">deep learning pipelines for Natural Language Processing, Computer Vision, and Music Information Retrieval</span>; and engineering cloud-native <span class="highlight-name" style="font-weight: 500;">CI/CD pipelines on AWS </span>for scalable AI applications.
                  </p>
                  <p>
                  My research interests lie in <span style="color: #f5c542; font-weight: 500;">Applied and trustworthy AI</span> systems that bridge foundation models with real operational workflows. I am particularly interested in building production-grade AI agents that combine LLM reasoning, retrieval, structured data, evaluation, and software engineering to solve complex business and manufacturing problems. Whether designing multi-agent systems, fine-tuning multimodal foundation models, or developing advanced analytics solutions, I am driven by the challenge of building AI systems that are not only intelligent, but reliable, explainable, measurable, and <span style="color: #f5c542; font-weight: 500;">trusted</span> by the people who depend on them.</div>
                  </p>
              """,
                  unsafe_allow_html=True
              )
...
with col2:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certmathformachinelearning.jpg"
    st.image(img_path, use_container_width=True)
...
with col3:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certibmgithub.jpg"
    st.image(img_path, use_container_width=True)
...
with col1:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certlangchain.jpg"
    st.image(img_path, use_container_width=True)
...
with col2:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certkeras.jpg"
    st.image(img_path, use_container_width=True)
...
with col3:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certtensorflow.jpg"
    st.image(img_path, use_container_width=True)
...
with col2:
  with st.container(border=True, height=550, horizontal_alignment="center"):
    ...
    img_path = BASE_DIR / "images" / "certpytorch.jpg"
    st.image(img_path, use_container_width=True)
...
st.markdown(
              """
              <div style="text-align:center; padding: 10px 0 26px 0;">
                <h3 style="font-size:1.5rem; font-weight:650; margin:0; color:#fcfcfc;">Badges</h3>
              </div>
              """,
              unsafe_allow_html=True,
          )
...
st.markdown(
            ...
            <div style="text-align:center; padding-bottom: 20px;">   
                <div style="margin-top: 0px;">
                    ...
                    <!-- View CV button -->
                <a href="https://drive.google.com/drive/folders/17apTI3N8BNSxbCasKDcmZS77oUuk1vCw?usp=share_link"
                   target="_blank"
